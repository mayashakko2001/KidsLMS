    ...
    public function getLevel(){
      ...
      public function show($id){
        ...
        if($level->is_quiz=='true'){
         $count = DB::table('quizs')->where('level_id', '=', $level->id)->count();
         if( $count==0){
        ...
        $count_l = DB::table('lessons')->where('level_id', '=', $level->id)->count();
        if( $count_l ==0){
        return response()->json([
          'message'=> 'not found',
          ]);
...
//....................................................................................................
    ...
    public function top_3_All(){
        ...
        ->get()->toArray();
    if( $top_student==[]){
        return $this ->success( 'not found',200,'');}
     //   $result = [];
